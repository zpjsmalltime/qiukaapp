...
public class SwipeBackLayout extends FrameLayout {
    ...
    public static final int FULL_DIRECTION_HORIZONTAL = ViewDragHelper.DIRECTION_HORIZONTAL;
    ...
    public void setSwipeMode(int mode,int size) {
        if (mode == SwipeBackLayout.ORIGINAL) {
            mDragHelper.setTouchedFullScreen(false, 0,size);
        } else {
            mDragHelper.setTouchedFullScreen(true, mode,size);
        }
    }
