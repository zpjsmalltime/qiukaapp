...
//        if(mHolder.mOffsetY!=0)return;
    ...
    private boolean isTouchDel = true;
    public void setTouchDel(boolean isTouchDel){
        this.isTouchDel = isTouchDel;
    }

    @Override
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if(!isTouchDel)return true;
...
//                mFooterCallBack.show(true);
    ...
    private int SCROLLBACK_DURATION = 200;
